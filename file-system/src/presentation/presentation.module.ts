...
const mockAuditService = {
  ...
  useValue: {
    logSecurityValidation: async () => console.log('Mock audit: security validation'),
...
const mockRateLimitService = {
  ...
  useValue: {
    checkLimit: async () => ({ allowed: true, limit: 100, resetTime: new Date() }),
    incrementCounter: async () => console.log('Mock rate limit: counter incremented'),
  }
};
...
const mockFileMetadataService = {
  ...
  useValue: {
    ...
    updateFileSecurityStatus: async () => console.log('Mock metadata: status updated'),
  }
};
...
const mockStorageService = {
  ...
  useValue: {
    ...
    moveToQuarantine: async () => console.log('Mock storage: moved to quarantine'),
  }
};
